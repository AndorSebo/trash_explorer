...
$api->version('v1', ['middleware' => 'api.auth', 'providers' => 'jwt'], function ($api) {
    ...
    $api->post('/avatarchange', 'App\Http\Controllers\AuthenticateController@avatarChange');
    ...
    $api->get('/getuserreports', 'App\Http\Controllers\ReportController@getUserReports');
